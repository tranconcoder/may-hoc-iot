...
router.get(
  "/active-cameras",
  catchError(statisticsApiController.getActiveCameras)
);
router.get(
  "/today-vehicles",
  catchError(statisticsApiController.getTodayVehicleCount)
);
...
router.get(
  "/last-30-minutes",
  catchError(statisticsApiController.getLast30MinutesStats)
);
router.get(
  "/traffic-alerts",
  catchError(statisticsApiController.getTrafficAlerts)
);
router.get(
  "/camera-locations",
  catchError(statisticsApiController.getCameraLocations)
);
